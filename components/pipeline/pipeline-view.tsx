  ...
  return (
    <section aria-labelledby="pipeline-heading">
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">{architecture === "cascaded" ? "Watch the active handoff and the technology used at each step." : "Audio travels both ways over WebRTC while one realtime model handles the conversation."} Click any step to inspect its Python equivalent.</p>
      </div>
