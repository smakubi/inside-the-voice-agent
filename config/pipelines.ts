...
export const cascadedStages: PipelineStageDefinition[] = [
  ...
  { id: "language-model", label: "Language Model", shortLabel: "Reason", description: "Text is interpreted and answered.", technology: `OpenAI · ${voiceModels.response}`, placeholderLatency: "— ms", status: "idle", icon: BrainCircuit },
...
export const realtimeStages: PipelineStageDefinition[] = [
  { id: "user-audio", label: "User Audio", shortLabel: "Listen", description: "Voice enters as rich audio.", technology: "Reference · WebRTC microphone", placeholderLatency: "— ms", status: "ready", icon: AudioLines },
  { id: "realtime-model", label: "Realtime Model", shortLabel: "Listen · Reason · Speak", description: "One multimodal model works directly with audio in and audio out.", technology: `Reference · ${voiceModels.realtimeReference}`, placeholderLatency: "— ms", status: "idle", icon: Radio },
  { id: "assistant-audio", label: "Assistant Audio", shortLabel: "Respond", description: "Voice returns in the same live flow.", technology: "Reference · WebRTC audio", placeholderLatency: "— ms", status: "idle", icon: Speech },
];
