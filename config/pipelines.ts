...
export const cascadedStages: PipelineStageDefinition[] = [
  ...
  { id: "language-model", label: "Large Language Model", shortLabel: "Reason", description: "Text is interpreted and answered.", technology: `Vercel AI SDK · Baseten · ${voiceModels.response}`, placeholderLatency: "— ms", status: "idle", icon: BrainCircuit },
